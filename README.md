...
```bash
composer require skillpedialms/laravel-h5p
```

Publish the Views, Config and so things.

```bash
publish php artisan vendor:publish --provider="SkillPedia\LaravelH5p\LaravelH5pServiceProvider"
```
...
```php
'providers' => [
    SkillPedia\LaravelH5p\LaravelH5pServiceProvider::class,
];
```
